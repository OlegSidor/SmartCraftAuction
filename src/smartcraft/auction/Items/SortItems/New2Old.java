...
public class New2Old implements Item {
  ...
  public ItemStack give() {
    ...
    itemMeta.setDisplayName(ChatColor.RED + "От новых к старым");
    itemMeta.addItemFlags(ItemFlag.HIDE_ATTRIBUTES);
    itemMeta.addItemFlags(ItemFlag.HIDE_ENCHANTS);
    itemMeta.getPersistentDataContainer().set(key, PersistentDataType.STRING, "New2Old");
